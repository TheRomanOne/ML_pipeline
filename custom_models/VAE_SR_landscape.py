...
class Encoder(nn.Module):
    def __init__(self, latent_dim):
        ...
        self.conv1 = nn.Conv2d(in_channels=3, out_channels=32, kernel_size=4, stride=2, padding=1)  # (32, 9, 16)
        self.batch_norm1 = nn.BatchNorm2d(32)
        self.conv2 = nn.Conv2d(32, 64, kernel_size=4, stride=2, padding=1)  # (64, 5, 8)
        self.batch_norm2 = nn.BatchNorm2d(64)
        self.conv3 = nn.Conv2d(64, 128, kernel_size=4, stride=2, padding=1)  # (128, 2, 4)

        self.flattened_size = 128 * 2 * 4
...
class Decoder(nn.Module):
    def __init__(self, latent_dim):
        ...
        self.fc = nn.Linear(latent_dim, 128 * 9 * 16)
...
class VAE_SR_landscape(nn.Module):
    def __init__(self, latent_dim):
        super(VAE_SR_landscape, self).__init__()
